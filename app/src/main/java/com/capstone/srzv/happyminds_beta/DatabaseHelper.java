package com.capstone.srzv.happyminds_beta;
...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    //Usuario
    public boolean insertUsuario(SQLiteDatabase db, String mail, int id, int pwd, String lastLog, String nombre){
        try{
            db.openDatabase(db_path+db_nombre,null, SQLiteDatabase.CREATE_IF_NECESSARY);
    ...
    //BackUp
    public boolean insertbackUp(SQLiteDatabase db, int id, String fecha, int userId){
        try{
            db.openDatabase(db_path+db_nombre,null, SQLiteDatabase.CREATE_IF_NECESSARY);
